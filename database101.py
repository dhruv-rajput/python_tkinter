...
conn = sqlite3.connect('address_book101.db')
...
def edit():
	...
	f_name_label.grid(row=0 , column=0,sticky=W,pady=(10,0),padx=(10,0))
...
delete_label.grid(row=9 , column=0,sticky=W,padx=(10,0))
